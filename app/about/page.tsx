      ...
      <div className="flex flex-col overflow-hidden rounded-xl border bg-gray-600 bg-opacity-95 py-2">
        <div className="flex flex-wrap items-center p-5 md:flex-nowrap">
          <div className="pb-4 md:pb-0 md:pr-8">
            ...
            <p>
              ...
              meet in the heart of Cappadocia. Opened in 2020, our boutique
              hotel blends the timeless charm of Cappadocia’s volcanic
              formations with the comfort and elegance of modern hospitality.
              Built into the region’s iconic fairy chimneys and natural stone
              structures, Sky Haven is more than a place to stay – it’s an
              experience that immerses you in the enchanting beauty of Göreme
        ...
        <div className="flex flex-row-reverse flex-wrap p-5 md:flex-nowrap">
          <div className="pb-4 md:pb-0 md:pl-8">
            ...
            <p>
              ...
              Yılmaz family, who are dedicated to preserving the authentic
              spirit of Cappadocia. The transformation of the property into a
              luxury retreat took over six years, carefully balancing tradition
              and comfort. Our 12 uniquely designed cave rooms and 8 stone rooms
              showcase the region’s historical architecture while offering
              guests a haven of relaxation.
              <br />
        ...
        <div className="p-5">
          ...
          <p className="pb-4 md:pb-0">
            ...
            the breathtaking spectacle of hundreds of hot-air balloons rising
            into the sky at sunrise. Enjoy your morning coffee or a traditional
            Turkish breakfast on our terraces as you take in the sweeping views
            of Göreme’s valleys, fairy chimneys, and vibrant skies.
            <br />
            Our terraces are also perfect for stargazing in the evenings,
            providing an unparalleled experience under Cappadocia’s
            crystal-clear skies.
          </p>
        </div>
        ...
        <div className="mx-auto md:w-1/2">
          <div className="p-5">
            ...
            <p className="text-center">
              Sky Haven is more than a hotel – it’s a family. Our dedicated
              team, led by Mr. Ahmet Yılmaz, takes pride in offering
              personalized service to every guest. From sharing local insights
              to arranging daily tours, hot-air balloon rides, and airport
              transfers, we’re here to ensure your stay is seamless and
              memorable.
            </p>
          </div>
        </div>
